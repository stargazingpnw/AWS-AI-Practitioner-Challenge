...
*   **Target Source:** Derived from the [peer-reviewed Mendeley Data repository](https://data.mendeley.com/datasets/s4ydf6kb8y/1): *"Association of food insecurity on gut microbiome and metabolome profiles in a diverse college-based sample"* (Mohr et al., 2022).
